<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        $sql = "SELECT korisnicko_ime, lozinka FROM korisnici WHERE email_adresa = ?";
        ...
        if($stmt = mysqli_prepare($db, $sql)) {
            ...
            if(mysqli_stmt_execute($stmt)) {
                ...
                if(mysqli_stmt_num_rows($stmt) == 1) {
                    mysqli_stmt_bind_result($stmt, $korisnicko_ime, $hashirani_password);
                    ...
                    if(mysqli_stmt_fetch($stmt)) {
                        ...
                        if(password_verify($_POST["lozinka"], $hashirani_password)) {
                            ...
                            header("Refresh:3; url=http://localhost/zadaca/php3/index.php", true, 303);
